...
import com.example.gamesuit.databinding.ListVideoBinding
...
class VideoAdpater(
    var context: Context,
    var videos: ArrayList<VideoData>,
    var videoPreparedListener: OnVideoPreparedListener
) : RecyclerView.Adapter<VideoAdpater.VideoViewHolder>() {

    class VideoViewHolder(
        var binding: ListVideoBinding,
        var context: Context,
        var videoPreparedListener: OnVideoPreparedListener
